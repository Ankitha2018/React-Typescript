...
import { BarChart, DonutChart } from "../../components/adminComponents/charts";
      ...
      <main className="dashboard">
        ...
        <section className="graph-container">
          <div className="revenue-chart">
            ...
            {/*Graph here */ } 
            <BarChart
              data_1={ [300, 144, 433, 655, 324, 855, 190] }
              data_2={ [200, 444, 485, 620, 752, 412, 782] }
              title_1="Revenue"
              title_2="Transaction"
          ...
          <div className="dashboard-categories">
            ...
            </div>
            {
              data.categories.map( (i) => (
                ...
                heading={i.heading}
                value={ i.value }
                color={`hsl(${i.value *4},${i.value}%,50%)`} />//the *4 is random number to change the color of the graph 
              ))
            }
            </div>
        </section>
